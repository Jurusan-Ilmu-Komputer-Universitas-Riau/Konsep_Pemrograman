...
```
Kumpulkan jawaban anda via CodePost](https://www.codepost.io/) dengan nama tugas: Penjumlahan dua waktu. Agar dapat mengumpulkan latihan melalui autograder codepost, ikuti tutorial [berikut](https://github.com/Jurusan-Ilmu-Komputer-Universitas-Riau/Modul_Belajar_Pemrograman/tree/main/codepost).
